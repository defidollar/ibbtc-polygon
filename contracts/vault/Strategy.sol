...
contract StrategySushiLpOptimizer is BaseStrategy {
    ...
    /// @notice Harvest sushi gains from Chef
    ...
    function harvest() external whenNotPaused returns (HarvestData memory) {
        ...
        harvestData.toStrategist = _processFee(sushi, harvestData.totalSushi, performanceFeeStrategist, strategist);
        harvestData.toGovernance = _processFee(sushi, harvestData.totalSushi, performanceFeeGovernance, IController(controller).rewards());
